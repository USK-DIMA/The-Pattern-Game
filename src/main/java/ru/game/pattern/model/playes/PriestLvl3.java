...
public class PriestLvl3 extends Priest {
    ...
    public static final String ICON_PATH = "prist/prist_icon3.jpg";
    ...
    public PriestLvl3(WindowInfo windowsInfo) throws IOException {
        ...
        playerRightImage = getResourseAsImage("prist/prist_right3.png");
        playerLeftImage = getResourseAsImage("prist/prist_left3.png");
    }
