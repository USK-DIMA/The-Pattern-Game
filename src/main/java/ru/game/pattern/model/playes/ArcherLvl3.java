...
public class ArcherLvl3 extends Archer {
    ...
    public static final String ICON_PATH = "archer/archer_icon3.jpg";
    ...
    public ArcherLvl3(WindowInfo windowsInfo) throws IOException {
        ...
        playerRightImage = getResourseAsImage("archer/archer_right3.png");
        playerLeftImage = getResourseAsImage("archer/archer_right3.png");
