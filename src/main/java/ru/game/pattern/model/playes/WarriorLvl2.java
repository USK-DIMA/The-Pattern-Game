...
public class WarriorLvl2 extends Warrior {
    ...
    public static final String ICON_PATH = "warrior/warrior_icon2.jpg";
    ...
    public WarriorLvl2(WindowInfo windowsInfo) throws IOException {
        ...
        playerRightImage = getResourseAsImage("warrior/warrior_right2.png");
        playerLeftImage = getResourseAsImage("warrior/warrior_left2.png");
