...
public class MagLvl3 extends Mag {
    ...
    public static final String ICON_PATH =  "mag/mag_icon3.jpg";
    ...
    public MagLvl3(WindowInfo windowsInfo) throws IOException {
        ...
        playerRightImage = getResourseAsImage("mag/mag_right3.png");
        playerLeftImage = getResourseAsImage("mag/mag_left3.png");
    }
